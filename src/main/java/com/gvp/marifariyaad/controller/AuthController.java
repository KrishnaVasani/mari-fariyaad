...
public class AuthController {
    ...
    public ResponseEntity<?> verifyRegistrationOtp(@Valid @RequestBody VerifyRegistrationRequest request,
                                                   HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        return verifyRegistration(request, httpRequest, httpResponse);
    }
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request,
                                    HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        if (authService.isEmailNotVerified(request.getUsername())) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(ApiMessageResponse.of(false, "Please verify your email using OTP before login."));
        }
    ...
    public ResponseEntity<ApiMessageResponse> verifyForgotPasswordOtp(@Valid @RequestBody VerifyResetOtpRequest request) {
        return verifyResetOtp(request);
    }
